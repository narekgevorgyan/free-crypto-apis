...
- Keep API names consistent. Do not duplicate the same API within a single category, but cross-listing across multiple relevant categories is allowed when it genuinely fits.
